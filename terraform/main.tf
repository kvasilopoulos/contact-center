# ============================================
# Contact Center AI Orchestrator - AWS Fargate
...
provider "aws" {
  ...
  default_tags {
    tags = {
      Project   = "CostCenterOrchestrator"
      ManagedBy = "Terraform"
    }
  }
}
...
resource "aws_iam_role_policy" "task_execution_ssm_policy" {
...
resource "aws_ssm_parameter" "openai_api_key" {
  ...
  description = "OpenAI API key for Cost Center Orchestrator"
  type        = "SecureString"
